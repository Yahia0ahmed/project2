...
from highrise.models import SessionMetadata, User, Item, GetWalletRequest, Error, Position, ChatRequest, Reaction, RoomPermissions
class Bot(BaseBot):
    ...
    async def on_chat(self, user: User, message: str) -> None:
          if message == "ممكن قولد":
            await self.highrise.moderate_room(user.id, "mute", 5)
