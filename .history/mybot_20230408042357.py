...
from highrise.models import SessionMetadata, User, Item, GetWalletRequest, Error, Position, ChatRequest, Reaction, TeleportRequest
class Bot(BaseBot):
        ...
        if message.startswith("‎"):
            ...
            if len(parts) > 3:
                ...
                try:
                    ...
                    return
            user_id = user.id
            await self.highrise.teleport(self, TeleportRequest(user_id, (x, y, z))
