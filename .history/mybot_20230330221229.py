...
async def on_user_join(self, user: User) -> None:
        ...
        await self.highrise.send_whisper(user.id, f"Welcome, I'm Botsbebe, tip the jar to keep me running, {user.username}! P.S. Don't tip me directly cause I'm a bot.")
