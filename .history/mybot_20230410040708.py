...
class Bot(BaseBot):
    async def messageLoop(self):
      while True:
        msg = ("قوانين مزاد النخبه 💸\n1. ممنوع منعاً باتاً السب والشتم داخل المزاد لاي سبب كان اذا كان لديك مشكله مع شخص الرجاء التواصل مع احد المشرفين.\2. دفع 100 كولد سعر دخول vip احراج ثلاث مرات او البيع مره واحده.")
