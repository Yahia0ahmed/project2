...
class Bot(BaseBot):
    async def messageLoop(self):
      while True:
        await self.highrise.chat("قوانين مزاد النخبه 💸1. ممنوع منعاً باتاً السب والشتم داخل المزاد لاي سبب كان اذا كان لديك مشكله مع شخص الرجاء التواصل مع احد المشرفين.
 
2. دفع 100 كولد سعر دخول vip احراج ثلاث مرات او البيع مره واحده.

3. دفع 50 كولد سعر دخول vip احراج مره واحده او البيع مره واحده. 

 4. عدم المزايده في السعر ان كنت لاتملك المبلغ الكافي خلاف ذلك تطرد.
 
5. احترام قوانین ومشرفي المزاد وعدم التخريب داخل المزاد خلاف ذلك تطرد نهائياً.

6. دفع 100 كولد اشتراك يومي للراغبين في إضافة كراب داخل المزاد

7. في حال حصول اي شخص على طرد من المزاد من دون سبب يرجى التواصل معي مباشر ( S_k_r ).
